...
**7 Agents · 8 Commands · 15 Skills · 1 Always-on Hook**

🌐 **เวอร์ชัน web สวยๆ อ่านง่าย:** [7-yod-kuman overview](https://claude.ai/code/artifact/486e539b-2c2c-4e35-a5dd-1dd77aafc615)
...
```
/plugin marketplace add thitiwut00897/7-yod-kuman
/plugin install 7-yod-kuman
```

อัปเดตด้วย `/plugin update 7-yod-kuman` — ตัว plugin อยู่ใน global cache ของ Claude Code ไม่แตะ repo ของคุณเลย มีเพียง `/init-project-docs` และ `/po-workflow` เท่านั้นที่เขียนไฟล์เข้าโปรเจกต์ และเฉพาะตอนที่คุณสั่งเอง
...
```
/plugin marketplace add /path/to/7-yod-kuman
/plugin install 7-yod-kuman
```
